            ...
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item">
                    ...
                    <a class="navbar-brand d-inline-block" href="<?php echo e(url('/')); ?>">
                        <img class="brand-logo" alt="Biorev" src="<?php echo e(asset('/media/logo2.png')); ?>">
                    </a>
                </li>
            </ul>
        </div>
...
</div><?php /**PATH /home/xhome/public_html/tkr.xhome360.com/cgi-bin/resources/views/elements/header.blade.php ENDPATH**/ ?>
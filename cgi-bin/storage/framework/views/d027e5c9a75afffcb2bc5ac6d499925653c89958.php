                                    ...
                                    <div class="row">
                                        <?php $__currentLoopData = $design_type->designs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $design): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="col-sm-4 col-6">
                                                <div class="design-container image-icons-wrap mb-1 <?php echo e(($design->is_default == 1)?'color-active':''); ?>">
                                                    <div data-design-title="<?php echo e($design_type->title); ?>" data-value="<?php echo e($design->title); ?>" class="w-100 design back-image <?php echo e(($design->is_default == 1)?'fade-image':''); ?>" style="background: rgb(<?php echo e($design->rgb_color); ?>); background-repeat:no-repeat; background-size: contain; background-position: center;"></div>
                                                    <span class="text-white d-flex <?php echo e(($design->is_default == 1)?'show-buttons':''); ?>">
                                                        <i data-feather="check-circle" class="mr-1 check-color-option <?php echo e(($design->is_default == 1)?'button-active':''); ?>"
                                                           ...
                                                           data-design-view1='<?php echo e(($design_type->image_view1)?asset($designpath.$design_type->slug."_".$design_type->id."/".$design_type->image_view1):""); ?>'
                                                           data-design-view2='<?php echo e(($design_type->image_view2)?asset($designpath.$design_type->slug."_".$design_type->id."/".$design_type->image_view2):""); ?>'
                                                           data-open-view='<?php echo e(($design->open_view_image)?asset($designpath.$design_type->slug."_".$design_type->id."/".$design->open_view_image):""); ?>'
                                                           data-open-view2='<?php echo e(($design->open_view2_image)?asset($designpath.$design_type->slug."_".$design_type->id."/".$design->open_view2_image):""); ?>'
...
<?php /**PATH D:\xampp\htdocs\biorev\ule-xdesign\cgi-bin\resources\views/includes/sidemenu.blade.php ENDPATH**/ ?>
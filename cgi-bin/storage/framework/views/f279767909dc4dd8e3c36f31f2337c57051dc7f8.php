            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <?php $__currentLoopData = $design_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $design_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a class="dropdown-item" href="javascript:void(0)"> <?php echo e($design_type->title); ?> </a>
                            <ul class="submenu dropdown-menu">
                                <li><a class="dropdown-item" href="javascript:void(0)" onclick="add_new_option('<?php echo e($design_type->slug); ?>','<?php echo e($design_type->id); ?>','<?php echo e($design_type->title); ?>')">Add Option</a></li>
                            </ul>
                        </li>
...
<?php /**PATH D:\xampp\htdocs\biorev\ule-2\cgi-bin\resources\views/includes/admin-bar.blade.php ENDPATH**/ ?>
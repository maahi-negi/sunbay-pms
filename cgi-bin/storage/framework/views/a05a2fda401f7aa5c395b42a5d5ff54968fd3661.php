            ...
            <div class="card" id="card<?php echo e($home->id); ?>">
                ...
                <div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted">
                    <span class="float-left suboption">
                        <?php if($home->exterior == 1): ?> <b class="badge badge-success">E</b> <?php endif; ?>
                        <?php if($home->floorplan == 1): ?> <b class="badge badge-success">F</b> <?php endif; ?>
                    </span>
                    <span class="float-right">
                        <a href="<?php echo e(route('elevations',['home_id' => base64_encode($home->id)])); ?>" data-toggle="tooltip" title="View Elevations" class="text-dark mr-25"> <i class="ft-eye"></i> </a>
                        <a href="javascript:;" onclick="HomePlanModal(true, '<?php echo e($home->title); ?>', '<?php echo e($home->status_id); ?>', '<?php echo e($home->base_image); ?>',<?php echo e($home->id); ?>,<?php echo e($home->exterior); ?>,<?php echo e($home->floorplan); ?>)" data-toggle="tooltip" title="Edit Homeplan" class="text-dark mr-25 edit-button"> <i class="ft-edit"></i> </a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xhome/public_html/tkr.xhome360.com/cgi-bin/resources/views/admin/homeplans.blade.php ENDPATH**/ ?>
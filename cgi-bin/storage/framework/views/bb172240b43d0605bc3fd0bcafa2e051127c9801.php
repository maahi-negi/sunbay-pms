                            ...
                            <div class="card-content">
                                <div class="card-body p-2">
                                    <div class="media mb-2">
                                        <img src="<?php echo e(asset('media/'.$admin->profile_image)); ?>" alt="users avatar" class="users-avatar-shadow rounded-circle mr-2" height="64" width="64">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" class="form-control" placeholder="Your Name" value="<?php echo e($admin->name); ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="mobile" class="text-uppercase mb-1">Contact</label>
                                        <input type="number" id="contact" class="form-control" placeholder="Your contact" value="<?php echo e($admin->mobile); ?>" required>
                                    </div>
...
const id = <?php echo e($admin->id); ?>, path = '<?php echo e(asset("media")); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xhome/public_html/ule-uat.xhome360.com/cgi-bin/resources/views/admin/profile.blade.php ENDPATH**/ ?>
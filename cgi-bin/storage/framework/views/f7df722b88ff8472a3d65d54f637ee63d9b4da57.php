        ...
        <div class="crop_box_container">
            ...
            <div>
                ...
                <div class="" style="width:300px;">
                    <img id="sourceImage" style="width: 100%;" src="<?php echo e(asset('media/placeholder.jpg')); ?>" alt="Source Image">
                </div>
            </div>
            <div style="display: flex;flex-direction: column;">
                <button onclick="cropImage()">Crop Image</button>
                <br>
                <img src="<?php echo e(asset('media/placeholder.jpg')); ?>" id="croppedImage" alt="Cropped Image" style="width: 76px;">
                <br>
                ...
                <select name="g_design_type" id="g_design_type">
                    <?php $__currentLoopData = $design_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $design_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($design_type->slug); ?>" data-id="<?php echo e($design_type->id); ?>"><?php echo e($design_type->title); ?></option>
...
<script>
    ...
    design_type_data.push({
        "design_type": "<?php echo e($design_type->slug); ?>",
        "image_view1": "<?php echo e($image_view1); ?>",
        "image_view2": "<?php echo e($image_view2); ?>",
        "image_view3": "<?php echo e($image_view3); ?>",
    });
    ...
    function closeCropBox() {
        ...
        cropper.destroy();
        document.getElementById('croppedImage').src = "<?php echo e(asset('media/placeholder.jpg')); ?>";
    ...
    function googleSaveImage(uploaded_image = '', design_type_val = '') {
        ...
        if(uploaded_image == '') {
            ...
            fetch('<?php echo e(url("/api/save-texture")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                ...
                body: JSON.stringify({
                    ...
                    title: img_title,
                    design_type: 2,
                    elevation_id: <?php echo e($design_group->id); ?>,
    ...
    function deleteDesign(id) {
        confirm('Are you sure?')?fetch('<?php echo e(url("/api/delete-design")); ?>', {
            method: 'delete',
            headers: {
                'Content-Type': 'application/json',
            },
...
<?php /**PATH /home/xhome/public_html/ule-uat.xhome360.com/cgi-bin/resources/views/includes/google.blade.php ENDPATH**/ ?>
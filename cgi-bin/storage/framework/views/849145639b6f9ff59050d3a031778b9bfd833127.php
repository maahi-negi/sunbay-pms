...
<header class="header">
    ...
    <div class="logo">
        <a href="/">
            <img src="<?php echo e(asset('uploads/'.$all_configs['logo'])); ?>" class="d-logo" alt="Biorev">
            <img src="<?php echo e(asset('uploads/'.$all_configs['logo'])); ?>" class="mob-logo" alt="Biorev">
        </a>
    </div>
</header>
<!-- Header End -->
...
<?php /**PATH /home/xhome/public_html/ule-uat.xhome360.com/cgi-bin/resources/views/includes/header-footer.blade.php ENDPATH**/ ?>
...
<div class="container">
    ...
    <ul class="grid list-style-none">
        ...
        <li class="card" id="card<?php echo e($home->id); ?>">
            <a class="card__link" href="<?php echo e(url("$home->slug")); ?>"><img class="card__image" src="<?php echo e(asset('media/uploads/exterior/'.$home->base_image)); ?>" />
            ...
            <a href="<?php echo e(url("$home->slug")); ?>" class="text-dark mr-25 badge badge-info" target="_blank" style="background: green;color: #fff !important;"> Preview </a>
        </li>
...
<?php /**PATH /home/xhome/public_html/ule-uat.xhome360.com/cgi-bin/resources/views/homes.blade.php ENDPATH**/ ?>
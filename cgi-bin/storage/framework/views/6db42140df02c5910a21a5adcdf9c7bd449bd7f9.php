...
<div class="content-wrapper row">
    <div class="content-body col-lg-3 col-md-6 mb-1">
        <div class="card-content">
            <a href="<?php echo e(route('exterior')); ?>">
                <div class="card-body" style="background: #fff;box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 3px 1px -2px rgba(0, 0, 0, 0.12), 0 1px 5px 0 rgba(0, 0, 0, 0.2);">
                    <div class="media d-flex">
                            <div class="media-body text-left">
                                <h3 style="color:#464855"><?php echo e($design_groups_count); ?></h3>
                                <h6 style="font-size: 1.2rem;">Elevations</h6>
                            </div>
                            <div>
...
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xhome/public_html/tkr.xhome360.com/cgi-bin/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>
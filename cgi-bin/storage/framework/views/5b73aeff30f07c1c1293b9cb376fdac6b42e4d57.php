 ...
 <div class="main-menu material-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item <?php echo e((isset($menu) && ($menu == 'exterior')) ?'active':''); ?> ">
                <a href="<?php echo e(route('exterior')); ?>"><span class="menu-title" data-i18n="Exterior"><i class="la la-object-group"></i>Elevations</span></a>
            </li>
            ...
            <li class="nav-item <?php echo e((isset($menu) && ($menu == 'api-data')) ?'active':''); ?> ">
                <a href="<?php echo e(route('api-data')); ?>"><span class="menu-title" data-i18n="API Data"><i class="ft-download-cloud"></i>API Data</span></a>
            </li>
        </ul>
    </div>
</div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/xhome/public_html/tkr.xhome360.com/cgi-bin/resources/views/elements/menu.blade.php ENDPATH**/ ?>
        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper pl-1">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('homeplans')); ?>">Homeplans</a>
                    </li>
                    <li class="breadcrumb-item"><u class="ml-25"> <?php echo e(ucwords($home_title)); ?></u>
                    </li>
                </ol>
            </div>
        </div>
...
<div class="content-wrapper">
    <div class="row">
        <?php $__currentLoopData = $elevations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $elevation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="card" id="card<?php echo e($elevation->id); ?>">
                <div class="card-header">
                    <h4 class="card-title text-capitalize"><b><?php echo e($elevation->title); ?></b>
                        <div class="heading-elements">
                            <?php if($elevation->status_id == 1): ?>
                                <span class="badge badge-success text-uppercase">active</span>
                            <?php elseif($elevation->status_id == 0): ?>
                ...
                <div class="card-content">
                    <img class="img-fluid" src="<?php echo e(asset('media/uploads/exterior/'.$elevation->base_image)); ?>">
                </div>
                <div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted">
                    <span class="float-left suboption">
                        <?php if($home->exterior == 1): ?>
                            <?php if($elevation->exterior == 1): ?> <b class="badge badge-success">E</b> <?php endif; ?>
                        <?php endif; ?>
                        <?php if($home->floorplan == 1): ?>
                            <?php if($elevation->floorplan == 1): ?> <b class="badge badge-success">F</b> <?php endif; ?>
                        <?php endif; ?>
                    </span>
                    <span class="float-right">
                        <a href="javascript:;" onclick="duplicateSwal(<?php echo e($elevation->id); ?>)" data-toggle="tooltip" title="Create Copy Of Elevation" class="text-dark mr-25"> <i class="ft-copy"></i> </a>
                        <a href="javascript:;" onclick="HomePlanModal(true, '<?php echo e($elevation->title); ?>', '<?php echo e($elevation->status_id); ?>', '<?php echo e($elevation->base_image); ?>',<?php echo e($elevation->id); ?>,<?php echo e($elevation->exterior); ?>,<?php echo e($elevation->floorplan); ?>)" data-toggle="tooltip" title="Edit Homeplan" class="text-dark mr-25 edit-button"> <i class="ft-edit"></i> </a>
                        <a href="javascript:;" onclick="deleteSwal(<?php echo e($elevation->id); ?>)" data-toggle="tooltip" title="Delete Homeplan" class="text-dark mr-25"> <i class="ft-trash-2"></i> </a>
                    </span>
                </div>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xhome/public_html/tkr.xhome360.com/cgi-bin/resources/views/admin/elevations.blade.php ENDPATH**/ ?>
                            ...
                            <div class="sync-container">
                                <div id="ss_step_div" class="text-center containers">
                                    ...
                                    <div class="row pl-1 pr-1 justify-content-between align-items-center choose-file-wrap">
                                        ...
                                        <a href="<?php echo e(url('media/bulk-upload-sample.xlsx')); ?>">
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-homePlan" role="tabpanel" aria-labelledby="pills-homePlan-tab">
                                            ...
                                            <div class="mapping-fields-wrapper" id="homePlan-tab">
                                                <p class="syncloader text-center my-2" style="display:none;"><img src="<?php echo e(asset('images/spinner.gif')); ?>"></p>
                                            </div>
                                        </div>
                                ...
                                <div id="sr_step_div" class="containers">
                                    ...
                                    <p class="uploadloader text-center my-2"><img src="<?php echo e(asset('images/spinner.gif')); ?>"></p>
                                    <div class="report-wrap">
                                        <div class="text-center sr-ans"> <i class="material-icons">done</i> <span>All data has been imported successfully.</span>
                                            <ul class="same-btns">
                                                <li> <a href="<?php echo e(route('bulk-data')); ?>">Import More Data </a> </li>
                                            </ul>
                                        </div>
                                        <div class="sr-synop">
                                            <h6>Activity Log </h6>
    ...
    <script>
        ...
        dataToShowInMapSection = () => {
            ...
            if(file != null){
                ...
                if(fileExtension == 'xlsx'){
                    $.ajax({
                        type        : "post",
                        url         : "<?php echo e(url("/api/map/sheet/columns")); ?>",
        ...
        function uploadData()
        {
            ...
            if(count!=0)
            {
                ...
                $.ajax({
                    type 		:'post',
                    url  		: '<?php echo e(url("/api/mega-import")); ?>',
                    headers     : {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                    data        : {'mapped':dat},
                    success		: function(response){
...
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xhome/public_html/ule.xhome360.com/cgi-bin/resources/views/admin/bulk-data.blade.php ENDPATH**/ ?>
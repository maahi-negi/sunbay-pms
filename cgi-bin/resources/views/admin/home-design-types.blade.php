            ...
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-capitalize">
                        <u class="ml-25">{{ ucwords($home_title) }}</u>
                    </li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="card" id="card{{$design_type->id}}">
                    ...
                    <div class="card-content bg-secondary py-3 text-center" style="height:160px">
                        <img class="img-fluid" src="{{asset('media/thumbnails/'.$design_type->thumbnail)}}" style="height: 100%;">
                    </div>
                    <div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted">
                        ...
                        <span class="float-right">
                            ...
                            <a href="javascript:;" onclick="designTypeModal(true, '{{$design_type->id}}', '{{$design_type->title}}', '{{$design_type->thumbnail}}', '{{$design_type->image_view1}}', '{{$design_type->priority}}','{{$design_type->status_id}}','{{$design_type->slug}}','{{$design_type->image_view2}}','{{$design_type->image_view3}}','{{$design_type->layer_option}}')" data-toggle="tooltip" title="Edit Design Type" class="text-dark mr-25 edit-button"> <i class="ft-edit"></i> </a>
...
<script>
    ...
    const layer_path = '{{asset("media/uploads/exterior")}}';
    var l = 1;
    var c = 0;
    var sc = 0;
    var rl = Array();
    ...
    function submitForm(editable){
        ...
        if(editable == true){
            ...
            $.ajax({
                type: 'post',
                url: '{{url("/api/edit-home-design-type")}}',
            ...
            $.ajax({
                type: 'post',
                url: '{{url("/api/add-home-design-type")}}',
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                data: formData,
                processData: false,
                contentType: false,
    ...
    function deleteDesignType(id){
        $.ajax({
            type: 'delete',
            url: '{{url("/api/delete-home-design-type")}}',
    ...
    function addBaseLayer(){
        let placeholder = "{{asset('media/placeholder.jpg')}}";
        l++;
    ...
    function getCategories(id){
        ...
        $.ajax({
            type: 'get',
            url: '{{url("/api/get-home-design-category")}}/'+id,
            success: function(response){

            ...
            <div class="card" id="card{{$home->id}}">
                ...
                <div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted">
                    <span class="float-left">
                        <a href="{{url("$home->slug")}}" class="text-dark mr-25 badge badge-info" target="_blank" style="color: #fff !important;"> Preview </a>
                    </span>
                    <span class="float-right">
                        <a href="{{route('home-design-types',['home_id' => base64_encode($home->id)])}}" data-toggle="tooltip" title="View Elevations" class="text-dark mr-25"> <i class="ft-eye"></i> </a>
                        <a href="javascript:;" onclick="HomePlanModal(true, '{{$home->title}}', '{{$home->status_id}}', '{{$home->base_image}}',{{$home->id}})" data-toggle="tooltip" title="Edit Homeplan" class="text-dark mr-25 edit-button"> <i class="ft-edit"></i> </a>

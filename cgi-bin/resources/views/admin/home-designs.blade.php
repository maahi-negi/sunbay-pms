                    ...
                    @foreach($designs as $key => $design)
                        <tr id="row{{$design->id}}">
                            ...
                            <td class="text-center">
                                ...
                                <a href="javascript:;" onclick="designModal(true, {{$design->id}}, '{{$design->title}}','{{$design->product_id}}', {{$design->status_id}},'{{@$rgb_color[0]}}','{{@$rgb_color[1]}}','{{@$rgb_color[2]}}','{{$design->hex_color}}', '{{$design->thumbnail}}', '{{$design->design_type}}','{{$design->additional_thumbs}}','{{$design->layer}}','{{$design->category}}', '{{$design->sub_category}}')" data-toggle="tooltip" title="Edit Design" class="mr-25 table-icon-btn"> <i class="ft-edit"></i> </a>
                                    ...
                                    <div class="form-group form-row">
                                        ...
                                        <div class="col generate-layer" style="display: none;">
                                            <div class="mr-2">
                                                ...
                                                <figure class="position-relative w-150 mb-0">
                                                    <img src="{{asset('media/placeholder.jpg')}}" class="img-thumbnail" id="layer-image" style="padding-top: 30px;">
                                ...
                                @if($design_type_categories)
                                    <div class="col">
                                        ...
                                        <select id="category" name="category" class="form-control border" onchange="getSubCategory()">
                                            ...
                                            @foreach($design_type_categories as $key => $cat)
...
@push('scripts')
    ...
    <script>
        ...
        // base layers
        const baseLayer1 = "{{($design_type->image_view1)?$design_type->image_view1:""}}";
        const baseLayer2 = "{{($design_type->image_view2)?$design_type->image_view2:""}}";
        const baseLayer3 = "{{($design_type->image_view3)?$design_type->image_view3:""}}";

                    ...
                    <div class="custom-scroll designs-scroll scroll-width-thin">
                        ...
                        @foreach($design_types as $design_type)
                            <div id="{{$design_type->slug}}Data" class="content-container custom-scroll scroll-width-thin">
                                @if(isset($design_type->categories) && count($design_type->categories)>1)
                                    <div class="category-filters">
                                        <div class="filters-wrapper open">
                                            <div class="select-fil-d-main">
                                                <select type="button" class="select-filter-input filter-category categories" data-design="{{$design_type->slug}}" data-type="cate">
                                                    <option value="">Select Category</option>
                                                    @foreach($design_type->categories as $c)
                                                        @if($c->parent_id=="")
                                        ...
                                        <div class="filters-wrapper open sub-category" style="display: none;">
                                            <div class="select-fil-d-main">
                                                <select type="button" class="select-filter-input filter-category filter-subcategory" data-design="{{$design_type->slug}}" data-type="subcate">
                                    ...
                                    <div class="row">
                                        @foreach($design_type->designs as $design)
                                            ...
                                            <div class="col-sm-4 col-6">
                                                <div class="design-container image-icons-wrap mb-1 {{($design->is_default == 1)?'color-active':''}} {{($design->category)?"cate$design->category":""}} {{($design->sub_category)?"subcate$design->sub_category":""}}">
                                                @if($design->thumbnail)
                                                    @php
                                        ...
                                        @if(Auth::check())
                                            <div class="col-sm-4 col-6 add-new-option">
                                                <div class="image-icons-wrap mb-1">
                                                    <div data-design-title="{{$design_type->title}}" class="w-100 design back-image" style="border: 1px solid #272323;"></div>
                                                    <span class="text-white" style="opacity: 1;">
                                                        <i data-feather="plus-circle" class="mr-1" onclick="add_new_option('{{$design_type->slug}}','{{$design_type->id}}','{{$design_type->title}}')"></i>
                                                    </span>
                                                </div>
                                            </div>
                                        @endif
